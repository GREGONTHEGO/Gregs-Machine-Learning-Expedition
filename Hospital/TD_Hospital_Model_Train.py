...
def data_preprocessing(df):
    ...
    col_to_keep = ['timeknown','cost', 'reflex','sex','blood', 'bloodchem1', 'bloodchem2',
                   'temperature','race','heart','psych1','glucose','psych2','dose', 'psych3', 
                   'bp', 'bloodchem3','confidence', 'bloodchem4', 'comorbidity', 'totalcost',
                   'breathing','age', 'sleep', 'dnr','bloodchem5','pdeath','meals','pain','primary', 
                   'psych4','disability','administratorcost','urine','diabetes','income','extraprimary',
...
def train_model(X, y):
    ...
    model = keras.Sequential([
        ...
        layers.Dense(64, activation='relu',kernel_regularizer=keras.regularizers.L1L2(l1=1e-3,l2=1e-2),bias_regularizer=regularizers.L2(1e-2),activity_regularizer=regularizers.L2(1e-3)),     # Hidden layer with 128 neurons and ReLU activation
        layers.Dense(64, activation='relu',kernel_regularizer=keras.regularizers.L1L2(l1=1e-3,l2=1e-2),bias_regularizer=regularizers.L2(1e-2),activity_regularizer=regularizers.L2(1e-3)),      # Another hidden layer with 64 neurons and ReLU activation 
